// source http://jsbin.com/mineyukuje/edit?js,console
...
assertEqual( daysInMonth(2016, 1), 31 );
assertEqual( daysInMonth(2016, 2), 29 );
assertEqual( daysInMonth(2016, 3), 30.958333333333332 );
assertEqual( daysInMonth(2016, 4), 30 );
assertEqual( daysInMonth(2016, 5), 31 );
assertEqual( daysInMonth(2016, 6), 30 );
